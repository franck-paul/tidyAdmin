...
L10n::$locales['CSS supplemental rules updated'] = 'Les règles CSS supplémentaires ont été mises à jour';
L10n::$locales['PO supplemental l10n updated'] = 'Les traductions supplémentaires ont été mises à jour';
L10n::$locales['HTML head supplemental directives updated'] = 'Directives supplémentaires pour la partie HTML head';
...
L10n::$locales['To permanently change theme go to <a href="%s">your preferences</a>.'] = 'Pour modifier définitivement le thème, rendez-vous dans <a href="%s">vos préférences</a>.';
...
L10n::$locales['Menu and dock'] = 'Menu et dock';
...
L10n::$locales['Display dock with favorites'] = 'Afficher le dock (barre avec les favoris)';
L10n::$locales['The dock will be hidden on small screens'] = 'Le dock sera caché sur les petits écrans';
L10n::$locales['Report the currently active favorite in the dock'] = 'Signaler le favori actuellement actif dans le dock';
L10n::$locales['Automatically hide/show the dock'] = 'Masquer/afficher automatiquement le dock';
L10n::$locales['The dock will be hidden/shown only if hovering over it is possible'] = 'Le dock ne sera caché/affiché que s\'il est possible de le survoler.';
...
L10n::$locales['Display direct access menus on preferences page'] = 'Afficher les menus d\'accès direct sur la page des préférences';
L10n::$locales['Keep the list of defined widgets visible while scrolling (widget management page)'] = 'Maintenir la liste des widgets définis visible pendant le défilement (page de gestion des widgets)';
...
L10n::$locales['Sample CSS:'] = 'Exemple de CSS :';
L10n::$locales['Supplemental JS'] = 'JS supplémentaire';
L10n::$locales['Note: this supplemental JS script will surcharge the default JS scripts.'] = 'Note : ce script JS supplémentaire viendra compléter les scripts JS par défaut.';
L10n::$locales['Sample JS:'] = 'Exemple de JS :';
L10n::$locales['Supplemental PO'] = 'PO supplémentaire';
...
L10n::$locales['Note: this supplemental HTML head directives will added to the default HTML head.'] = 'Note : Ces directives d\'entête HTML seront ajoutées au head par défaut.';
L10n::$locales['Sample HTML head:'] = 'Exemple de directives supplémentaires pour le head HTML :';
